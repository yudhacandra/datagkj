    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                <p><b><h3><div class="text-center"><u> FORM EDIT STRUKTUR KOMISI </u></div></h3></b></p>
            <div class="contact-form-area">
                    <form action="" method="POST" >
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" name="edit_struktur_komisi" class="btn btn-info">Simpan</button>
                            </div>
