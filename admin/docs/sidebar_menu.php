<aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item" href="dashboard.php"><span class="app-menu__label">Dashboard</span></a></li>
        <li><a class="app-menu__item" href="data-jemaat.php"><span class="app-menu__label">Data Jemaat</span></a></li>
        <li><a class="app-menu__item" href="admin.php"><span class="app-menu__label">Admin</span></a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><span class="app-menu__label">Bidang Majelis</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="data_majelis.php"><i class="app-menu__icon fa fa-minus" aria-hidden="true"></i>Majelis</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><span class="app-menu__label">Pelayanan Gereja</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="pelayanan_baptis.php"><i class="app-menu__icon fa fa-minus" aria-hidden="true"></i>Baptis</a></li>
            <li><a class="treeview-item" href="pelayanan_katekisasi.php"><i class="app-menu__icon fa fa-minus" aria-hidden="true"></i>Katekisasi</a></li>
          </ul>
        </li>
