...
$insert = mysqli_query($conn,"INSERT INTO `pelayanan_katekisasi` (`id_katekisasi`, `pemohon_katekisasi`, `jenis_katekisasi`, `jadwal_registrasi`, `jadwal_katekisasi`, `petugas_katekisasi`, `keterangan`, `status`) VALUES ('$idk', '$pk', '$jnk', '$jr', '$jk', '$ptk', '$kt', '$st');");
if($insert){ 
   ...
   <main class="app-content">
      <div class="app-title">
        <div>
          ...
          </svg> Tambah Data Pemohon Katekisasi</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
            <p><b><h3> <div class="text-center"><u> FORM TAMBAH DATA PEMOHON KATEKISASI </u></div></h3></b></p>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id_katekisasi="contact-name" name="id_katekisasi">
                              </div>
                            </div>
