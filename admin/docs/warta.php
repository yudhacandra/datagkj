...
?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-id-badge" aria-hidden="true"></i></i> Warta GKJ Boyolali</h1>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              ...
              <a href="proses_tambah_warta.php" class="btn btn-info ml-2"><i class="app-menu__icon fa fa-plus" aria-hidden="true"></i></a>
            </div>
          </form>
