...
$proker = mysqli_query($conn, "UPDATE `proker` SET `id_proker`='$idp',`bidang`='$bdg',`nama_proker`='$np',`jenis_kegiatan`='$jk',`waktu`='$wkt',`keterangan`='$ket' WHERE id_proker='$id'");
if ($proker) {
...
$proker = mysqli_query($conn, "SELECT * FROM `proker` where id_proker='$id'");
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          </svg>  Edit Program Kerja Tahunan</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                <p><b><h3><div class="text-center"><u> FORM EDIT PROGRAM KERJA TAHUNAN </u></div></h3></b></p>
                        ...
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="col-12 col-lg-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?=  $data['nama_proker']; ?>"  name="nama_proker">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?=  $data['jenis_kegiatan']; ?>"  name="jenis_kegiatan">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?=  $data['waktu']; ?>"  name="waktu">
                                </div>
                            </div>
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" name="edit_proker" class="btn btn-info">Simpan</button>
                            </div>
