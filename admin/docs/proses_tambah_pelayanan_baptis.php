...
$insert = mysqli_query($conn,"INSERT INTO `pelayanan_baptis` (`id_baptis`, `pemohon_baptis`, `jenis_baptis`, `jadwal_registrasi`, `jadwal_baptis`, `petugas_baptis`, `keterangan`, `status`) VALUES ('$idb', '$pb', '$jnb', '$jr', '$jb', '$ptb', '$kt', '$st');");
if($insert){ 
   ...
   <main class="app-content">
      <div class="app-title">
        <div>
          ...
          </svg> Tambah Data Pemohon Baptis</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
            <p><b><h3> <div class="text-center"><u> FORM TAMBAH DATA PEMOHON BAPTIS </u></div></h3></b></p>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id_baptis="contact-name" name="id_baptis">
                              </div>
                            </div>
