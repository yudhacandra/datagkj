...
$jm=$_POST['jabatan_majelis'];
$jlam=$_POST['jumlah_anggota_majelis'];

$insert = mysqli_query($conn,"INSERT INTO `struktur_majelis` (`id_majelis`, `periode_majelis`, `jabatan_majelis`, `jumlah_anggota_majelis`) VALUES ('$idm', '$pm', '$jm', '$jlam')");
if($insert){ 
            ...
            <div class="contact-form-area">
                    <form action="" method="POST" >
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-10">
                              <div class="form-group">
                                <label for="contact-name"><b>Jabatan Bidang Majelis :</b></label>
                                <input type="text" class="form-control" name="jabatan_majelis">
                              </div>
                            </div>
                            <div class="col-12 col-lg-10">
                              <div class="form-group">
